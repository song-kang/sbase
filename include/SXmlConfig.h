...
// 描    述:  基于DOM解析的配置文件基类
//////////////////////////////////////////////////////////////////////////
class SBASE_EXPORT SXmlConfig : public SBaseConfig
{
	enum SBASE_EXPORT STR_ENCODING
	{
		STR_ENCODING_GB2312,
		STR_ENCODING_UTF8
	};
public:
	...
	//////////////////////////////////////////////////////////////////////////
	bool ReadText(const char* sXmlText);
	...
	// 参数说明:  @sXml为输出的XML文本
	//            @sEncoding字符集编码,缺省为GB2312，""表示不生成XML语法头
	// 返 回 值:  true表示保存成功，false为失败
	//////////////////////////////////////////////////////////////////////////
	bool SaveConfigToText(SString &sXml,SString sEncoding="GB2312");
	...
	// 返 回 值:  true表示读取成功，false表示读取失败
	//////////////////////////////////////////////////////////////////////////
	bool LoadXmlByText(const char * szXmlText);
